...
# this is how I generate my plots
...
ggplot(data_aggregate, aes(x = Total_Death_Count)) +
  ...
  labs(title = "Frequency of Death Counts",
       x = "Total Death Count",
       y = "Frequency") +
  theme_minimal()
```
...
ggplot(death_data_all_plotting, aes(x = week_of_month, fill = week_of_month)) +
  geom_bar() +
  labs(title = "Deaths by Week of the Month",
       x = "Week of the Month",
       y = "Number of Deaths") +
  theme_minimal()
...
ggplot(warm_season_deaths, aes(x = block, fill = factor(block))) +
  geom_bar() +
  labs(title = "Deaths by Time Strata",
       x = "Time Strata",
       y = "Number of Deaths") +
  theme_minimal()
...
ggplot(yearly_counts, aes(x = year, y = count)) +
  ...
  labs(title = "Yearly Count of Deaths with Cocaine or Stimi",
       x = "Year", y = "Count") +
  theme_minimal()
...
ggplot(death_data_filtered, aes(x = month)) +
  ...
  labs(title = "Distribution of Death Dates by Month with Cocaine or Other Stimulant Contribution",
       x = "Month", y = "Frequency") +
  theme_minimal()
...
ggplot(opioid_freq_df, aes(x = Opioid_Contributing, y = Frequency)) +
  geom_bar(stat = "identity", fill = "skyblue", color = "black") +
  labs(title = "Frequency of Opioid Contribution in Deaths",
...
ggplot(cocaine_freq_df, aes(x = Cocaine_Contributing, y = Frequency)) +
  ...
  labs(title = "Frequency of Cocaine Contribution in Deaths",
...
ggplot(other_stimi_freq_df, aes(x = Other_Stimuli_Contributing, y = Frequency)) +
  geom_bar(stat = "identity", fill = "skyblue", color = "black") +
  labs(title = "Frequency of Other Stimuli Contribution in Deaths",
...
combined_df <- data.frame(Contributions = c("Only Opioid", "Both Opioid and Cocaine", "Both Opioid and Other Stimi"),
...
ggplot(combined_df, aes(x = Contributions, y = Frequency)) +
  geom_bar(stat = "identity", fill = "lightgreen", color = "black") +
  labs(title = "Frequency of Different Combinations of Contributions in Deaths",
       x = "Contributions",
       y = "Frequency") +
  theme_minimal()
...
# Create a dataframe for plotting
combined_df <- data.frame(Contributions = c("Only Opioid", "Only Cocaine", "Only Other Stimi"),
...
common_limits <- range(c(death_count_county_20002010$death_count,
...
common_limits <- range(c(death_rate_county_20002009$death_rate,
...
common_limits <- range(c(death_rate_county_20002011$death_rate,
...
ggplot(death_data_aggregated, aes(x = year, y = TotalDeaths, fill = simple_race)) +
  ...
  labs(title = "Total Deaths per Year by Race (2000-2022)",
       x = "Year",
       y = "Total Deaths",
       fill = "Race") +  # Adjust the legend title
  theme_minimal() +
  scale_y_log10() +
...
# Create a color palette for each race
race_colors <- c("White Non-Hispanic" = "skyblue", 
...
race_order <- c("White Non-Hispanic", 
                "Black Non-Hispanic", 
...
ggplot(death_data_aggregated, aes(x = year, y = TotalDeaths, color = simple_age)) +
  ...
  labs(title = "Deaths by Age (2000-2022)",
       x = "Year",
       y = "Total Deaths") +
  theme_minimal() +
  theme(plot.title = element_text(family = "Times New Roman", hjust = 0.5),
...
age_colors <- c("0-17" = "blue", "18-24" = "cornflowerblue", "25-34" = "darkorange", 
...
ggplot(death_data_aggregated, aes(x = year, y = TotalDeaths, fill = simple_age)) +
  ...
  labs(title = "Deaths by Age (2000-2022)",
       x = "Year",
       y = "Total Deaths",
       fill = "Age Group") +  # Adjust the legend title
  theme_minimal() +
  theme(plot.title = element_text(family = "Times New Roman", hjust = 0.5),
        panel.grid = element_blank())  # Remove gridlines
...
plot1 <- ggplot(death_data_aggregated, aes(x = year, y = TotalDeaths, color = SVI_tertile)) +
  geom_line(size = 1) +  # Adjust line thickness
  scale_color_manual(values = age_colors) +  # Assign colors to each race
  labs(title = "Deaths by SVI Tertile (2000-2022)",
       x = "Year",
       y = "Total Deaths") +
  theme_minimal() +
  theme(plot.title = element_text(family = "Times New Roman", hjust = 0.5),
...
ggplot(death_data_aggregated, aes(x = year, ymin = 0, ymax = TotalDeaths, fill = SVI_tertile, order = SVI_tertile)) +
  ...
  labs(title = "Deaths by SVI Tertile (2000-2022)",
       x = "Year",
       y = "Total Deaths",
       fill = "SVI Tertile") +  # Adjust the legend title
  theme_minimal() +
  scale_y_log10() +
  theme(plot.title = element_text(family = "Times New Roman", hjust = 0.5),
        panel.grid = element_blank())  # Remove gridlines
...
plot1 <- ggplot(death_data_aggregated, aes(x = year, y = TotalDeaths, color = sex)) +
  geom_line(size = 1) +  # Adjust line thickness
  scale_color_manual(values = age_colors) +  # Assign colors to each race
  labs(title = "Deaths by Sex (2000-2022)",
       x = "Year",
       y = "Total Deaths") +
  theme_minimal() +
  theme(plot.title = element_text(family = "Times New Roman", hjust = 0.5),
...
ggplot(death_data_aggregated, aes(x = year, ymin = 0, ymax = TotalDeaths, fill = sex, order = sex)) +
  ...
  labs(title = "Deaths by Sex (2000-2022)",
       x = "Year",
       y = "Total Deaths",
       fill = "Sex") +  # Adjust the legend title
  theme_minimal() +
  theme(plot.title = element_text(family = "Times New Roman", hjust = 0.5),
        panel.grid = element_blank())  # Remove gridlines
...
MaxTempVP_X$HeatIndex = heat.index(t = MaxTempVP_X$MaxTemperatureF,
