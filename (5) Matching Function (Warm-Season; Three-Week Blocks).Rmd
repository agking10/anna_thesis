...
# Andrew - this is the matching function for the warm season deaths. It should pair each death with the controls in the same strata (three-week period). FYI this takes like many hours to run with all the data
...
warm_season_deaths <- read.csv(file.path(thesis_files_dir, "warm_season_deaths.csv"))
cool_season_deaths <- read.csv(file.path(thesis_files_dir, "cool_season_deaths.csv"))

data_warm_season <- read.csv(file.path(thesis_files_dir, "data_warm_season.csv"))
data_cool_season <- read.csv(file.path(thesis_files_dir, "data_cool_season.csv"))
...
# write.csv(matched_data_warm_blocks, "~/Thesis Work/Thesis Files/warm_season_matched_data_blocks_2022.csv", row.names = FALSE)
